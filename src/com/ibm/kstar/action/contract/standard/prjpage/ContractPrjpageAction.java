 ...
 * 
 */
package com.ibm.kstar.action.contract.standard.prjpage;
 ...
 */
@Controller
@RequestMapping("/standard/prjpage")
//@Scope("prototype")
public class ContractPrjpageAction extends BaseAction {
	Logger logger = LoggerFactory.getLogger(getClass());

	private final static String CONTRACT_PROCESS_KEY = "contrPrjpage";
...
//		
//		//generate aftsale 
//		KstarAftSale aftsale = contractService.getKstarAftSale(contrId);
//		if(aftsale==null){
...
//		condition.setCondition("cType", "0005");
	...
	public String befsale(String contrId,String typ,Model model) {

		TabMain tabMain1 = new TabMain(Style.top);
		tabMain1.addTab("IDU", "/standard/prjpage/idu.html?contrId="+contrId+"&typ="+typ);//z
		tabMain1.addTab("IDM", "/standard/prjpage/idm.html?contrId="+contrId+"&typ="+typ);
		tabMain1.addTab("单UPS", "/standard/prjpage/sngups.html?contrId="+contrId+"&typ="+typ);
		tabMain1.addTab("单电池", "/standard/prjpage/sngbty.html?contrId="+contrId+"&typ="+typ);//z
		tabMain1.addTab("单空调", "/standard/prjpage/sngclr.html?contrId="+contrId+"&typ="+typ);
		tabMain1.addTab("单配电", "/standard/prjpage/sngelec.html?contrId="+contrId+"&typ="+typ);
		tabMain1.addTab("单机柜", "/standard/prjpage/sngrck.html?contrId="+contrId+"&typ="+typ);
		tabMain1.addTab("单监控", "/standard/prjpage/sngmnt.html?contrId="+contrId+"&typ="+typ);
	...
	public String editIdu(KstarIdu idu, HttpServletRequest request){
		String cType = request.getParameter("typ"); // "0005";
//		contractService.updateIdu(idu,cType);
...
//		String cType = request.getParameter("typ"); // "0005";
//		contractService.updateIdm(idm,cType);
...
//		String cType = "0005";
	...
	public String addPginf(KstarPgInf pginf,String typ, HttpServletRequest request) {
		String cType = typ; //"0005";
	...
	public String addPginf(String typ,Model model){
		model.addAttribute("typ",typ);
