 ...
 * 
 */
package com.ibm.kstar.action.contract.pi.prjlst;
 ...
 */
@Controller
@RequestMapping("/pi/prjlst")
//@Scope("prototype")
public class ContrPiPrjlstAction extends LovMemberAction  {
	...
	public String pagePrjLst(PageCondition condition, HttpServletRequest request) {
		...
		IPage p = contractPiService.queryPrjLst(condition);
	...
	public String addPrjlst(LovMember lovMember,KstarPrjLst prjLst){
		...
		contractPiService.savePrjLst(prjLst,cType);
		
		contractPiService.updateAllAvgttl(lovMember, prjLst); 
	...
	public String editPrjlst(String id,Model model,String contrId){
		...
		KstarPrjLst prjLst = contractPiService.getKstarPrjLst(contrId, lvId);
	...
	public String editPrjlst(LovMember lovMember,KstarPrjLst prjLst){
		...
		contractPiService.updatePrjLst(lovMember,prjLst);
		contractPiService.updateAllAvgttl(lovMember, prjLst); 
	...
	public String deletePrjlst(String id,String contrId){
		...
		contractPiService.deletePrjLst(id,contrId);
		contractPiService.updateAllAvgttlByQcode(contrId);
		return sendSuccessMessage();
	}
