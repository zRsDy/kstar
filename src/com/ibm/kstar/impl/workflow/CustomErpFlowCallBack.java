...
public class CustomErpFlowCallBack extends IXflowInterface{
	...
	public void onComplete(String businessKey, String flowModule, String processInstanceId,String comment) {
		custom.updateErpInfoAfterProcess(businessKey, IConstants.CUSTOM_NORMAL_STATUS_40);
	}
	...
	public void onReject(String businessKey, String flowModule, String processInstanceId, String comment) {
		custom.updateErpInfoAfterProcess(businessKey, IConstants.CUSTOM_NORMAL_STATUS_30);
	}
