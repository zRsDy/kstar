...
public class OrderStatementAuditFlowCallBack extends IXflowInterface{
	@Autowired
	...
	public void onComplete(String businessKey, String flowModule, String processInstanceId,String comment) {
		statementService.updateStatus(businessKey, IConstants.ORDER_CONTROL_STATUS_30, null);
	}
	...
	public String processPath() {
		return "/statement/edit.html";
	}

	@Override
	public void onReject(String businessKey, String flowModule, String processInstanceId, String comment) {
		statementService.updateStatus(businessKey, IConstants.ORDER_CONTROL_STATUS_40, null);
	}
