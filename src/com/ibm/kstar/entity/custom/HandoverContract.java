...
@Entity
@Table(name = "crm_t_ho_contr_basic")
public class HandoverContract implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@GeneratedValue(generator = "crm_t_ho_contr_basic_id_generator")
	@GenericGenerator(name="crm_t_ho_contr_basic_id_generator", strategy="uuid")
	@Column(name = "C_ID")
	private String id;
	...
	public void setContrTypeName(String contrTypeName) {
		this.contrTypeName = contrTypeName;
	}

	public void setContrStatName(String contrStatName) {
		this.contrStatName = contrStatName;
	}
	...
	public void setFinalReviewStatDesc(String finalReviewStatDesc) {
		this.finalReviewStatDesc = finalReviewStatDesc;
	}

	public void setPayStatDesc(String payStatDesc) {
		this.payStatDesc = payStatDesc;
	}

	public void setShipWayDesc(String shipWayDesc) {
		this.shipWayDesc = shipWayDesc;
	}

	public void setBussEnityName(String bussEnityName) {
		this.bussEnityName = bussEnityName;
	}
