...
@Entity
@Table(name = "crm_t_custom_comp_achi_biz")
public class CustomCompAchiBusiness implements java.io.Serializable {
    /** 版本号 */
    private static final long serialVersionUID = 6518304175925292969L;
    
    /** 主键自增 */
    @Id
    @GeneratedValue(generator = "comp_achi_biz_generator")
	@GenericGenerator(name="comp_achi_biz_generator", strategy="uuid")
    ...
    /** 行业名称 */
    @Column(name = "c_industry_code", nullable = false, length = 32)
