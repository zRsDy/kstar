...
@Entity
@Table(name = "crm_t_order_header_change")
@Permission(businessType = IConstants.PERMISSION_BUSINESS_TYPE_ORDER_CHANGE)
public class OrderHeaderChange extends BaseEntity implements java.io.Serializable  {
	...
	@GeneratedValue(generator = "order_h_c_id_generator")
	@GenericGenerator(name = "order_h_c_id_generator", strategy = "uuid")
	@PermissionBusinessId
	private String id;
	
	/** 订单变更编号 */
	@Column(name = "c_change_code")
	...
	@Column(name = "c_from_id")
	private String fromId;

    
    @Column(name = "c_event_status")
    private String eventStatus;
   
    @Transient
    private String eventStatusLable;
	...
	public String getEventStatusLable() {
		return this.getLovMember("ORDER_CONTROL_STATUS", eventStatus).getName();
	}
	public void setEventStatusLable(String eventStatusLable) {
		this.eventStatusLable = eventStatusLable;
	}
