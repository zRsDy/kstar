...
@Entity
@Table(name = "crm_t_order_lines_change")
public class OrderLinesChange implements java.io.Serializable {
	/** 版本号 */
	...
	@GeneratedValue(generator = "order_l_c_id_generator")
	@GenericGenerator(name = "order_l_c_id_generator", strategy = "uuid")
	private String id;
	
	@Column(name = "c_from_id")
	private String fromId;
	
	@Column(name = "c_order_change_id")
