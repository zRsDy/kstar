...
public interface IInvoiceService {
	...
	//设置流程参数
	void setBusinessVariable(String businessKey,String processInstanceId,Participant participant );
	
	/**
	 * 校验开票申请对应的发货行的状态是否可以开票,同时校验开票数量不可以大于ERP可开票数量
	 * @param businessKey 开票申请id
	 */
	void validateCanInvoice(String businessKey);
