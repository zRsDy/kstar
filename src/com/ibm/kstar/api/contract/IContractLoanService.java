 ...
 *
 */
public interface IContractLoanService {
	...
	String getContractLoanNumber() throws AnneException;
...
//	void startContractReviewProcess1(UserObject user,String[] ids) throws AnneException;

	void startContractTrialProcess(UserObject user,String contrId,String typ) throws AnneException;

//	List<HistoryActivityInstance> getContrReviewHisLst(String module, String contrId) throws AnneException;
	...
	IPage queryVeriPrjLst(PageCondition condition) throws AnneException;
	
	IPage queryVeriOrderPrjLst(PageCondition condition)  throws AnneException;
	
	List<List<Object>> exportContractsHead(PageCondition condition,String typ,String[] ids) throws AnneException;
	
	List<Contract> countTolRecdAmt(List<Contract> list);
     ...
     * @return
     */
	List<List<Object>> exportLoanverification(PageCondition condition);
	 ...
	 * @return
	 */
	List<List<Object>> exportLoanVerificationByCustomer(PageCondition condition);
     ...
     * @return
     */
	List<List<Object>> exportLoanVerificationBySalesman(PageCondition condition);
     ...
     * @return
     */
	List<List<Object>> exportLoanVerificationBySalesDepartmant(PageCondition condition);

    List<List<Object>> reportExportContractsHead(PageCondition condition, String typ, String[] ids) throws AnneException;
	 ...
	 * @return
	 */
	List<List<Object>> exportUnverificationLoan(PageCondition condition);

    void updateHighRiskFlag(String id, String isHighRisk);

    BigDecimal unverificationSum(Condition condition);

	IPage unverificationLoanPage(PageCondition condition);
}
