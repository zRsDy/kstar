...
public class ProductSelectAction extends BaseAction{
	...
	public String selectProductList(String pickerId,Model model,HttpServletRequest request){
		...
		String allCsaleStatus = request.getParameter("allCsaleStatus");//是否查询所有销售状态
		...
		model.addAttribute("allCsaleStatus",allCsaleStatus);
	...
	public String page(PageCondition condition,HttpServletRequest request) throws Exception{
		...
		String allCsaleStatus = condition.getStringCondition("allCsaleStatus");
        ...
        if(!"true".equals(allCsaleStatus)){
        	sql.append(" and p.C_SALE_STATUS = '89d4488e5a1bc49e015a1c6e43570006'");
        }
