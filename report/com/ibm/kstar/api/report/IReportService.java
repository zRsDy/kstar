...
public interface IReportService {
	...
	List<LovMember> getLovList(String rootId, String groupId, String leafFlag, String parentId, String posId);
	
	int getSaleSupportReportScale(String type, String id);
	
	int getOverdueNoReturnPrototypeSum(String type, String id,String year);
